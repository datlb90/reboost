      ...
      <div class="row">
        <div class="col-lg-6">
          <div class="repair-about-content">
            ...
            <ul>
              <li><span><feather type="check" /> Experienced Professionals</span></li>
              <li><span><feather type="check" /> Expert Technical Skills</span></li>
              <li><span><feather type="check" /> Excellent Reputation</span></li>
              <li><span><feather type="check" /> Friendly Service</span></li>
              <li><span><feather type="check" /> Trustworthy See Reviews</span></li>
              <li><span><feather type="check" /> Affordable Diagnosis</span></li>
            </ul>
          </div>
        </div>
