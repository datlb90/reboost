<template>
  ...
  <section class="solutions-area ptb-80">
      ...
      <div class="row">
        <div class="col-lg-3 col-sm-6 col-md-6">
          <div class="solutions-box">
            ...
            <a href="#" class="learn-more-btn"><feather type="plus-circle" /> Learn More</a>
          </div>
        </div>
    ...
    <div v-wow class="shape9 wow fadeInLeft slow"><img src="../../../assets/img/agency-image/shape1.png" alt="image"></div>
  </section>
