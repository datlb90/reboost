...
import ToolBar from '../../controls/Viewer_ToolBar'
import TabQuestion from '../../../views/learner/Review_TabQuestion'
// PDFJSAnnotate
  ...
  data() {
    return {
      ...
      RENDER_OPTIONS: {
        ...
        rotate: parseInt(localStorage.getItem(`${9604}/rotate`), 10) || 0
      },
      newComment: '',
      comments: [],
      viewerWidth: 900,
