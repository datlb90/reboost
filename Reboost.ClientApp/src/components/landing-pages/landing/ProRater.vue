<template>
  <!-- Start Features Area -->
  <section v-if="screenWidth > 780" class="features-area-two ptb-80 bg-f7fafd" style="padding-top: 120px; padding-bottom: 120px;">
    <div class="container">
      ...
      <div class="row h-100 justify-content-center align-items-center" style="text-align: center;">
        <div class="container">
          <div class="section-title">
            <h5 style="font-size: 30px;">{{ messageTranslates('proRater', 'title') }}</h5>
            <div class="bar" />
            <p style="text-align: justify;">{{ messageTranslates('proRater', 'description') }}</p>
          </div>
        </div>
