  ...
  <div class="col-lg-6 col-md-12">
    <div class="order-details">
      ...
      <div class="payment-method">
        <p>
          <input id="direct-bank-transfer" type="radio" name="radio-group" checked>
        ...
        <p>
          <input id="cash-on-delivery" type="radio" name="radio-group">
          <label for="cash-on-delivery">Cash on Delivery</label>
        </p>
      </div>

      <a href="javascript:void(0)" class="btn btn-primary order-btn" @click="placeOrder">Place Order</a>
    </div>
  </div>
</template>
