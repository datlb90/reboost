  ...
  <el-col :span="18" :offset="3" class="padding-10" style="min-width: 480px;">
    ...
    <el-row>
      <el-col :span="12" class="padding-10" style="padding-right: 15px;">
        <el-row style="margin-bottom: 25px;">
          <el-col :span="24">
            <div class="image-ielts" v-bind:class="{'question-con': selectIELTS}" style="height: 225px; padding: 0; border: 1px solid #ebeef5;" @click="selectScoreIELTS()">
              <img src="../assets/img/LogoIELTS.png" alt="" style="height:100%; width: 100%;">
            </div>
          </el-col>
        </el-row>
        <el-row style="margin-bottom: 25px;" v-bind:class="{'show': selectIELTS, 'hide-container': !selectIELTS}">
          <el-col :span="24" class="select-score-ielts question-con">
            ...
            <el-select style="width: 140px" v-model="scoreIELTS" placeholder="Select Score">
              <el-option v-for="item in score" :key="item" :label="item" :value="item"></el-option>
            </el-select>
          </el-col>
        </el-row>
        <el-row class="row-flex" v-bind:class="{'show': selectIELTS, 'hide-container': !selectIELTS}">
          <el-col :span="24">
            <div class="tip">
      ...
      <el-col :span="12" class="padding-10" style="padding-left: 15px;">
        <el-row style="margin-bottom: 25px;">
          <el-col :span="24">
            <div @click="selectScoreTOEFL()" style="height: 225px; padding: 0; border: 1px solid #ebeef5;" class="image-ielts" v-bind:class="{'question-con': selectTOEFL}">
              <img src="../assets/img/LogoTOEFL.png" alt="" style="height:100%; width: 100%;">
            </div>
          </el-col>
        </el-row>
        <el-row style="margin-bottom: 25px;" v-bind:class="{'show': selectTOEFL, 'hide-container': !selectTOEFL}">
          <el-col :span="24" class="select-score-ielts question-con">
            <span style="font-style:normal ;font-size: 15px; margin-right: 15px;">Select You Current TOEFL Writing Score</span>
            <el-select style="width: 140px" v-model="scoreTOEFL" placeholder="Select Score">
              <el-option v-for="item in score" :key="item" :label="item" :value="item"></el-option>
            </el-select>
          </el-col>
        </el-row>
        <el-row class="row-flex" v-bind:class="{'show': selectTOEFL, 'hide-container': !selectTOEFL}">
          <el-col :span="24">
            <div class="tip">
              <p>Please use your best guess if you don't already have one</p>
            </div>
    ...
    <el-row>
      <el-col class="padding-10">
        <el-button v-on:click="submit">Continue</el-button>
      </el-col>
    </el-row>
  </el-col>
</el-row>
