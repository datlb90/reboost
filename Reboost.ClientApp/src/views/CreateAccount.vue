      ...
      <el-form ref="formRegister" :model="formRegister" label-width="180px" style="width:90%;">
        ...
        <el-form-item label="Occupation" prop="occupation" :rules="[
          ...
          <el-select v-model="formRegister.occupation" placeholder="Please select an suits you best" style="width: 100%;">
            <el-option v-for="item in occupation" :key="item" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
        <el-form-item label="First Language" prop="firstLanguage" :rules="[
          ...
          <el-select v-model="formRegister.firstLanguage" placeholder="Please select an suits you best" style="width: 100%;">
            <el-option v-for="item in firstLanguage" :key="item" :label="item" :value="item">
            </el-option>
          </el-select>
        </el-form-item>
  ...
  methods: {
    onSubmit(formName) {
      this.$refs[formName].validate((valid) => {
        if (valid) {
          var valPhoto = [];
          this.formRegister.iDCardPhotos.forEach(u => valPhoto.push(u.raw));
          this.formRegister.iDCardPhotos = valPhoto;

          var valIelts = [];
          this.formRegister.iELTSCertificatePhotos.forEach(u => valIelts.push(u.raw));
          this.formRegister.iELTSCertificatePhotos = valIelts;

          var valToefl = [];
          this.formRegister.tOEFLCertificatePhotos.forEach(u => valToefl.push(u.raw));
          this.formRegister.tOEFLCertificatePhotos = valToefl;

          raterService.insert(this.formRegister)
        } else {
