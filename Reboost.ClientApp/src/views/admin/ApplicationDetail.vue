      ...
      <el-col :span="15" class="col-border">
        <el-form ref="formRegister" :model="formRegister" label-width="180px" style="width:90%;">
          ...
          <el-form-item size="mini" style="margin: 0;">
            ...
            <el-button v-if="raterId && formRegister.status !== RATER_STATUS.DOCUMENT_REQUESTED" class="button" size="mini" type="danger" @click="updateStatus(RATER_STATUS.REJECTED)"> Reject </el-button>
            <el-button v-if="raterId && (formRegister.status === RATER_STATUS.APPLIED || formRegister.status===RATER_STATUS.DOCUMENT_REQUESTED)" :disabled="!formRegister.note" class="button" size="mini" type="danger" @click="updateStatus(RATER_STATUS.DOCUMENT_REQUESTED)">Document Request</el-button>
