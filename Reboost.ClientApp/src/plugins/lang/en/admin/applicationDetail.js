export const ApplicationDetail = {
  ...
  ieltsUploadTips: 'Please upload your IELTS test result, and any other supporting credidentials you may have. Files must be less than 500kb in size.',
  ...
  toeflUploadTips: 'Please upload your TOEFL test result, and any other supporting credidentials you may have. Files must be less than 500kb in size.',
  photoId: 'Photo ID',
  photoIdRequired: 'ID Photos is required',
  photoIdUploadTips: 'Please upload a form of photos identification such as ID card, driver license, or passport. The file must be less than 500kb in size.',
  biography: 'Biography',
